...
var Matrix4 = function(x, y, z) {
	...
	this.setRotationX = function(degrees) {
		...
		e[4] = 0;	e[5] = Math.cos(radians);	e[6] = -1*Math.sin(radians);	e[7] = 0;
	...
	this.setRotationY = function(degrees) {
		...
		e[8] = -1*Math.sin(radians);	e[9] = 0;	e[10] = Math.cos(radians);	e[11] = 0;
		e[12] = 0;	e[13] = 0; e[14] = 0;	e[15] = 1;
	...
	this.setRotationZ = function(degrees) {
		...
		e[0] = Math.cos(radians);	e[1] = -1*Math.sin(radians);	e[2] = 0;	e[3] = 0;
	...
	this.setPerspective = function(fovy, aspect, near, far) {
		...
		//Video reference: https://www.youtube.com/watch?v=k3dhGlAx_DA at 8:33 minutes
